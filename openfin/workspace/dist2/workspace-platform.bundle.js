...
(() => {
  ...
  (() => {
    ...
    typeof window < "u" && window.addEventListener("post-fin-injection", () => {
    ...
    const Kt = new Promise((e) => {
      ...
      typeof window < "u" ? window.addEventListener("post-fin-injection", () => e(), { once: !0 }) : e();
    }), qt = (Mt.Local, Mt.Dev, Mt.Staging, Mt.Prod === "prod"), kn = (e) => e.startsWith("http://") || e.startsWith("https://") ? e : Tt + e, Rn = kn("https://workspace.openfin.co/workspace/22.3.32"), Wt = kn("https://workspace.openfin.co/workspace/22.3.32"), ln = (typeof WORKSPACE_DOCS_PLATFORM_URL < "u" && kn(WORKSPACE_DOCS_PLATFORM_URL), typeof WORKSPACE_DOCS_CLIENT_URL < "u" && kn(WORKSPACE_DOCS_CLIENT_URL), "42.138.103.904"), Vt = "22.3.32";
